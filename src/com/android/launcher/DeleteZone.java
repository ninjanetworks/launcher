...
public class DeleteZone extends ImageView implements DropTarget, DragController.DragListener {
    ...
    /*
     * @Override protected void onFinishInflate() { super.onFinishInflate(); mTransition = (TransitionDrawable)
     * getBackground(); }
     */
    ...
    public void onDragStart(View v, DragSource source, Object info, int dragAction) {
        ...
        if (item != null) {
            ...
            if (item instanceof ApplicationInfo) {
                ...
                final AppWidgetProviderInfo aw = AppWidgetManager.getInstance(mLauncher).getAppWidgetInfo(
