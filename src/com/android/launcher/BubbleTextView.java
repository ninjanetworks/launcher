...
/**
 * TextView that draws a bubble behind the text. We cannot use a LineBackgroundSpan because we want to make the bubble
 * taller than the text and TextView's clip is too aggressive.
 */
public class BubbleTextView extends CounterTextView {
    ...
    private void init() {
        ...
        if (!themePackage.equals(Launcher.THEME_DEFAULT)) {
            ...
            if (themeResources != null) {
                ...
                if (cornerId != 0) {
                    mCustomCornerRadius = themeResources.getInteger(cornerId);
                }
            }
        }
    ...
    //
    // rect.set(left + layout.getLineLeft(0) - mPaddingH, top + layout.getLineTop(0) - mPaddingV,
