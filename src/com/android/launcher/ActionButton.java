...
public class ActionButton extends CounterImageView implements DropTarget, DragListener, OnLongClickListener, DragSource {
    ...
    public Rect estimateDropLocation(DragSource source, int x, int y, int xOffset, int yOffset, Object dragInfo,
                    Rect recycle) {
        return null;
    }
    ...
    public void onDrop(DragSource source, int x, int y, int xOffset, int yOffset, Object dragInfo) {
        ...
        if (accept) {
            ...
            LauncherModel.addOrMoveItemInDatabase(mLauncher, info, mIdent, -1, -1, -1);
    ...
    protected void UpdateLaunchInfo(ItemInfo info) {
        ...
        if (info != null) {
            ...
            case LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET:
                ...
                return;
            default:
                // Toast t2=Toast.makeText(getContext(), "Unknown item. We can't add unknown item types :-)",
                // Toast.LENGTH_SHORT);
                // t2.show();
                return;
    ...
    /**
     * ADW: Reload the proper icon This is mainly used when the apps from SDcard are available in froyo
     */
    ...
    public boolean onLongClick(View v) {
        if ((mDragger == null) || !v.isInTouchMode() || (mCurrentInfo == null) || specialMode
                        || mLauncher.isDesktopBlocked() || areABLocked(mLauncher)) {
            return false;
        }
