...
class LiveFolderAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        if (!mIsList) {
            ...
            if (themeFont != null) {
                holder.description.setTypeface(themeFont);
            }
        ...
        if (themeFont != null) {
            holder.name.setTypeface(themeFont);
        }
        ...
        if (data != null) {
            ...
            if (icon == null) {
                ...
                icon = new FastBitmapDrawable(
                                Utilities.createBitmapThumbnail(bitmap, mLauncher.getApplicationContext()));
            ...
            if (icon == null) {
                try {
                    ...
                    icon = Utilities.createIconThumbnail(resources.getDrawable(id), mLauncher.getApplicationContext());
