...
public class PreviewPager extends ViewGroup {
    ...
    private void createLayout() {
        ...
        if (mEnableGroupText && mShowGroupText) {
            ...
            if (groupTitle != null) {
                ...
                int childWidthSpec = getChildMeasureSpec(MeasureSpec.makeMeasureSpec(textWidth, MeasureSpec.EXACTLY),
                                0, p.width);
        ...
        for (int i = 0; i < mTotalItems; i++) {
            ...
            int childHeightSpec = getChildMeasureSpec(MeasureSpec.makeMeasureSpec(dotWidth, MeasureSpec.UNSPECIFIED),
                            0, p.height);
            int childWidthSpec = getChildMeasureSpec(MeasureSpec.makeMeasureSpec(dotWidth, MeasureSpec.EXACTLY), 0,
                            p.width);
    ...
    private String getCurrentGroupTitle() {
        ...
        if (drawerAdapter != null) {
            ...
            groupTitle = (index == AppGroupAdapter.APP_GROUP_ALL ? getContext().getString(title) : AppCatalogueFilters
                            .getInstance().getGroupTitle(index));
        }
        return groupTitle;
    }
