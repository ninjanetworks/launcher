...
public class AllAppsSlidingView extends AdapterView<ApplicationsAdapter> implements OnItemClickListener,
                OnItemLongClickListener, DragSource, Drawer {// implements DragScroller{
    ...
    public AllAppsSlidingView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AllAppsSlidingView, defStyle, 0);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        // canvas.clipRect(scrollX + getPaddingLeft(), scrollY, scrollX + getRight() - getLeft(), scrollY
        // + getBottom() - getTop());
        ...
        for (int i = 0; i < mNumRows; i++) {
            for (int j = 0; j < mNumColumns; j++) {
                if (pos < mAdapter.getCount()) {
                    ...
                    int childHeightSpec = getChildMeasureSpec(MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED),
                                    0, p.height);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_UP:
            if (mTouchState == TOUCH_STATE_SCROLLING) {
                ...
                /*
                 * int moveScreens=Math.round(velocityX/1000); int destinationScreen=mCurrentScreen-moveScreens;
     ...
     * 
     * @param direction
     *            either {@link View#FOCUS_LEFT}, {@link View#FOCUS_RIGHT}, {@link View#FOCUS_UP} or
    ...
    class RecycleBin {
        ...
        void fillActiveViews(int childCount, int firstActivePosition) {
            ...
            for (View activeView : activeViews) {
        ...
        void scrapActiveViews() {
            ...
            for (int i = 0; i < count; ++i) {
                ...
                if (victim != null) {
                    int whichScrap = ((AllAppsSlidingView.LayoutParams) victim.getLayoutParams()).viewType;
    ...
    void keyPressed() {
        ...
        if ((selector != null) && (isFocused() || touchModeDrawsInPressedState()) && (selectorRect != null)
    ...
    private boolean performLongPress(final View child, final int longPressPosition, final long longPressId) {
        ...
        if (getOnItemLongClickListener() != null) {
            handled = getOnItemLongClickListener().onItemLongClick(AllAppsSlidingView.this, child, longPressPosition,
                            longPressId);
        }
        if (handled) {
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (AllAppsSlidingView.this.getAdapter().hasStableIds() && (mInstanceState != null) && (mOldItemCount == 0)
                            && (mItemCount > 0)) {
    ...
    public void open(boolean animate) {
        ...
        mPager.showGroupText(mLauncher.useDrawerTitleCatalog
